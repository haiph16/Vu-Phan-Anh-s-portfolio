    ...
    <div className="space-y-1 ">
      {lines.map((line, idx) => {
        ...
        return (
          <p
            key={idx}
            className={`leading-tight text-sm md:text-lg text-left ${isDarkMode ? "text-gray-300" : "text-white-700"} ${isBoldLine ? "font-bold" : "font-normal"}`}
          >
            {line}
          </p>
        );
  ...
  return (
    <div className="">
      ...
      >
        {/* Header */}
        <header
          className={`fixed w-full left-0 top-0 z-50 backdrop-blur-lg ${isDarkMode ? "bg-slate-900/60" : "bg-white/60"} ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}
        >
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex items-center justify-between lg:justify-evenly">
              ...
              <nav className="hidden md:flex items-center gap-8 text-xl ">
                <a
                  href="#about"
                  className={`nav-link ${navValue === "about" ? "active" : ""} ${isDarkMode ? "text-gray-300 hover:text-gray-100" : "text-gray-600 hover:text-gray-900"} transition font-medium`}
                >
                  ABOUT
                </a>
                <a
                  href="#projects"
                  className={`nav-link ${navValue === "projects" ? "active" : ""} ${isDarkMode ? "text-gray-300 hover:text-gray-100" : "text-gray-600 hover:text-gray-900"} transition font-medium`}
                >
                  PROJECTS
                </a>
                <a
                  href="#contact"
                  className={`nav-link ${navValue === "contact" ? "active" : ""} ${isDarkMode ? "text-gray-300 hover:text-gray-100" : "text-gray-600 hover:text-gray-900"} transition font-medium`}
                >
                  CONTACT
                </a>
              </nav>
        ...
        >
          ...
          <div className="max-w-9xl relative z-10 mb-2">
            ...
            >
              <h2
                className={`animate-fadeInDown ${isDarkMode ? "text-white" : "text-green-800 "} md:text-2xl lg:text-3xl text-xl font-bold mb-2 md:mb-6 justify-center items-center scroll-mb-65`}
              >
          ...
          <div className="max-w-7xl mx-2">
            <div className="grid md:grid-cols-[1fr_2fr]  items-start  ">
              ...
              <div className="content-animate order-1 md:order-2  lg:pl-[42px] ">
                ...
                <p
                  className={`${isDarkMode ? "text-gray-300" : "text-gray-600"} mb-3 mx-2 sm:mb-8 lg:pt-3 align-baseline leading-relaxed text-md md:text-xl lg:text-[27px] text-left tracking-tighter`}
                >
                ...
                {tabsConfig.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative flex flex-col items-center justify-center gap-2 sm:gap-4 py-4 sm:py-8 px-2 sm:px-4 rounded-xl transition-all duration-300 backdrop-blur-lg border shadow-lg ${
                        isActive
                          ? `${isDarkMode ? "bg-[#f7f7f7] scale-105" : "bg-linear-to-r from-[#e4f3ee] to-green-50 scale-105"} text-green-700 shadow-lg`
                          : `${isDarkMode ? "bg-gray-700 border-gray-600 text-gray-300 hover:text-gray-100 hover:bg-gray-600 hover:scale-130" : "bg-white border-green-200 text-gray-700 hover:text-gray-900 hover:bg-green-100/50 hover:scale-130"}`
                      }`}
                    >
                      <Icon
                        className={`transition-all duration-300 size-[26px] md:size-[36px] ${
                          isActive ? "scale-120 md:scale-145" : "scale-100"
                        }`}
                      />
                ...
                {activeTab === "Academic Profiles" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {[
                      ...
                      >
                        <div
                          className={`relative overflow-hidden rounded-xl h-full flex flex-col ${isDarkMode ? "bg-slate-700 border-slate-600" : "bg-white/80 border-gray-100/50"} border shadow-md transition-all duration-300 hover:-translate-y-0.5`}
                        >
                          <div className="relative overflow-hidden md:h-48 h-32">
                            <div
                              className={`absolute inset-0 bg-linear-to-br py-2 md:py-4 ${item.color} to-transparent opacity-50 group-hover:opacity-70 transition-opacity`}
                            ></div>
                          ...
                          <div className="flex flex-col flex-1 p-4 sm:p-5 mb-12 md:mb-16">
                            <div
                              className={`flex items-center gap-3 text-md md:text-lg ${isDarkMode ? "text-gray-400" : "text-gray-500"} mb-3`}
                            >
                              <time
                                dateTime={item.date}
                            ...
                            <h3
                              className={`text-[14px] md:text-[16px] text-left font-bold mb-3 ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-2  transition`}
                            >
                              {item.title}
                            </h3>
                    ...
                    {[
                      {
                        ...
                        focus: [
                          "Green credit development in Japan",
                          "Transparency in climate-related loan programmes",
                          "Policy approaches and institutional practices",
                      ...
                      <article
                        key={idx}
                        className={`card-animate group ${isDarkMode ? "bg-slate-700 border-slate-600" : "bg-white border-green-200"} rounded-xl overflow-hidden hover:shadow-xl shadow-md transition-shadow duration-300`}
                      >
                        <div className="flex flex-col md:flex-row">
                          ...
                          <div className="md:w-2/3 w-full md:p-6 p-4 pt-2">
                            ...
                            {/* Title */}
                            <h3
                              className={`text-md md:text-xl font-bold ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-3 whitespace-pre-line transition leading-tight`}
                            >
                              {item.title}
                              {item.paperLink && (
                                <>
                                  ...
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={`inline-flex items-center gap-2text-blue-800 hover:text-green-800 font-semibold text-sm md:text-base transition-all hover:gap-1`}
                                  >
                                    <svg
                                      className="w-5 h-5"
                                      fill="none"
                ...
                {activeTab === "Awards & Honors" && (
                  <div className="grid sm:grid-cols-2 grid-cols-1 gap-6 sm:gap-8">
                    {[
                      ...
                      <article
                        key={idx}
                        className="card-animate group h-full cursor-pointer"
                      >
                        <button
                        ...
                        >
                          <div
                            className={`relative overflow-hidden rounded-xl h-full flex flex-col ${isDarkMode ? "bg-gray-700/50 border-gray-600/50" : "bg-white/80 border-gray-100/50"} border shadow-md transition-all duration-300 hover:-translate-y-0.5`}
                          >
                            {/* Featured Image */}
                            <div className="relative overflow-hidden h-40 md:h-48 cursor-pointer">
                              <div
                                className={`absolute inset-0 bg-linear-to-br py-4 ${item.color} to-transparent opacity-50 group-hover:opacity-70 transition-opacity`}
                              ></div>
                              <img
                                src={item.img}
                                alt={item.title}
                            ...
                            <div className="flex flex-col flex-1 p-5 sm:p-6">
                              ...
                              {/* Title */}
                              <h3
                                className={`textmd md:text-lg  font-bold ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-3  transition leading-tight`}
                              >
                                {item.title}
                              </h3>
                              {/* Description */}
                              ...
                              >
                                <span
                                  className={`${isDarkMode ? "text-white hover:text-gray-300" : "text-green-800 hover:text-green-600"} font-medium text-sm sm:text-base transition flex items-center gap-2 group-hover:gap-3 cursor-pointer`}
                                >
                                  View Image
                                  <svg
                  ...
                  <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 sm:gap-6">
                    {[
                      ...
                      >
                        <button
                          onClick={() =>
                            handleImageOpen([leadership1, leadership2], idx)
                          }
                          x
                          className="block h-full w-full text-left"
                        >
                          ...
                          >
                            ...
                            <div className="flex flex-col flex-1 p-5 sm:p-6">
                              ...
                              {/* Title */}
                              <h3
                                className={`text-md md:text-lg  font-bold whitespace-pre-line  ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-3  transition leading-tight`}
                              >
                                {item.title}
                              </h3>
                ...
                {activeTab === "Extracurricular Experiences" && (
                  <div className="grid sm:grid-cols-2 sm:[&>*:nth-child(1)]:col-span-2 grid-cols-1 gap-6 sm:gap-8">
                    {[
                      ...
                      {
                        title:
                          " English Club | Foreign Language Specialized School ",
                      ...
                      {
                        title:
                          " Academic & Leadership Programs (UK) Embassy Summer  ",
                        color: "from-gray-500/20",
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="flex flex-col flex-1 p-5 sm:p-6">
                              ...
                              {/* Title */}
                              <h3
                                className={`text-lg font-bold whitespace-pre-line ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-3  transition leading-tight`}
                              >
                                {item.title}
                              </h3>
                ...
                {activeTab === "Social Impacts" && (
                  <div className="grid sm:grid-cols-2 sm:[&>*:nth-child(1)]:col-span-2 grid-cols-1 gap-4 sm:gap-6">
                    {[
                      {
                        title:
                          " The Smile Charity Community (Nụ Cười Yêu Thương) ",
                        img: socialimpact2,
                        color: "from-gray-500/20",
                        link: "#",
                        author: "Member",
                      ...
                      {
                        title:
                          " “Tết vì người bệnh” Fundraising Campaign Canadian English Council",
                        img: socialimpact1,
                        color: "from-gray-500/20",
                        link: "#",
                        author: "Co-ordinator",
                      ...
                      {
                        title:
                          " Book Translation Project: End Plastic Soup \n Rotary Club ",
                        img: socialimpact3,
                        color: "from-gray-500/20",
                        link: "#",
                        author: "Translator",
                      ...
                      >
                        <button
                          onClick={() =>
                            handleImageOpen(
                              [socialimpact1, socialimpact2, socialimpact3],
                              idx,
                            )
                          }
                          className="block h-full w-full text-left"
                        >
                          ...
                          >
                            ...
                            <div className="flex flex-col flex-1 p-5 sm:p-6">
                              ...
                              {/* Title */}
                              <h3
                                className={`text:md md:text-lg whitespace-pre-line font-bold ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} mb-3  transition leading-tight`}
                              >
                                {item.title}
                              </h3>
                              {renderBoldBullets(item.desc, isDarkMode)}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 md:gap-6 gap-4">
                  <div className="flex items-center justify-center lg:items-end gap-3 sm:gap-4 pr-10 sm:pr-0">
                    ...
                    <div>
                      <h3
                        className={`hidden md:block ${isDarkMode ? "text-gray-100" : "text-gray-900 hover:text-green-800"} font-medium mb-1 text-xl`}
                      >
                        Email
                      </h3>
                      <p
                  ...
                  <div className="flex justify-center items-center gap-6 sm:gap-8">
                    <div className="flex items-center justify-center lg:items-end gap-3 sm:gap-4 pr-10 sm:pr-0">
                      <div
                        className={`size-8 md:size-10 sm:w-12 sm:h-12 bg-green-800 rounded-full flex items-center justify-center shrink-0`}
                      >
                        <svg
                          className="w-5 h-5 sm:w-6 sm:h-6 text-white"
                          fill="none"
