  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div
          className={`flex items-center justify-between md:p-6 p-2 ${isDarkMode ? "border-gray-700/50 bg-gradient-to-r from-gray-800 to-gray-800/80" : "border-gray-100 bg-gradient-to-r from-white to-gray-50/50"} border-b`}
        >
          <h2
            className={`text-lg sm:text-xl font-semibold ${isDarkMode ? "text-gray-100" : "text-gray-800"} truncate`}
          >
            {title}
          </h2>
          <button
        ...
        {/* Image Container */}
        <div
          className={`flex-1 flex items-center justify-center overflow-auto p-4 md:p-8 ${isDarkMode ? "bg-gray-900/50" : "bg-gray-50/50"}`}
        >
          <img
            src={image}
            alt={title}
        ...
        {hasNavigation && (
          <div
            className={`flex items-center justify-between gap-4 p-3 md:p-6border-t ${isDarkMode ? "border-gray-700/50 bg-gradient-to-r from-gray-800/80 to-gray-800" : "border-gray-100 bg-gradient-to-r from-gray-50/50 to-white"}`}
          >
            <button
              onClick={onPrev}
